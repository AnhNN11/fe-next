...
import { useAddFinanceMutation, useAddFundsMutation } from "@/store/queries/finances";
...
function AddFunds(props: AddExpenseProps) {
	...
	const handleSubmit: FormProps["onFinish"] = (values) => {
		...
		console.log(data);
		values.creator = "66648ad3d92e40785bca9f4d";
	...
	return (
		<S.UserModal {...props} title={t("modal.title")}>
			{contextHolder}
			<Form
				form={form}
				labelCol={{ span: 4 }}
